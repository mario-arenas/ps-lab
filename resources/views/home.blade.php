...
@section('content')
    ...
    <div class="container-fluid block-large" id="work">
        <div class="row no-gutter">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/american-girl" class="thumb-wrapper">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/food-network" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                                <p>Food Network</p>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/skip-hop" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                                <p>Skip Hop</p>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/better-homes-and-gardens" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/flexees-by-maidenform" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/target-halloween" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/sesame-street" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                                <p>Sesame Street</p>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/walmart-holiday-time" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/american-greetings" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/american-girl-girl-of-the-year" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/fabio-viviani" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
    ...
    LICENSING SUCCESS</p>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/rolling-stones" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                                <p>Rolling Stones</p>
    ...
    CULTURAL ICON</p>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/discovery-consumer-products" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
    ...
    OF PRODUCTS AND SERVICES</p>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/nfl" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                                <p>NFL</p>
    ...
    MERCHANDISE STYLE GUIDE</p>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/mike-rowe-works" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                                <p>Mike Rowe Works</p>
    ...
    AMERICAN BRAND</p>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/french-toast" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                                <p>French Toast</p>
    ...
    REPOSITION AND RELAUNCH</p>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <a href="/work/discovery-destinations" class="thumb-wrapper">
                        <div class="overlay text-center">
                            <div>
                    ...
                    <div class="text-center pad-large">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <h3 class="uppercase">
                                    <a href="/services/research-insights">
                                        <div>Research</div> 
                                        <div>& Insights</div>
                                    </a>
                                </h3>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <h3 class="uppercase">
                                    <a href="/services/positioning-image">
                                        <div>Positioning</div>
                                        <div>& Image</div>
                                    </a>
                                </h3>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <h3 class="uppercase">
                                    <a href="/services/retail-activation">
                                        <div>Retail</div>
                                        <div>Activation</div>
                                    </a>
                                </h3>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <h3 class="uppercase">
                                    <a href="/services/licensing-representation">
                                        <div>Licensing &</div>
