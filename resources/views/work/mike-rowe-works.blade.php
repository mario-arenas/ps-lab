...
@section('content')
    ...
    <div class="container canvas block-moderate browser">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-md-6 text-center work-logos">
                    ...
                    <img src="/images/uploads/blog/604/parhamsantana_brandextension_mikeroweworks_logo.png" class="hidden-xs" style="height: 75px; width: auto;" />
                    <img src="/images/uploads/blog/604/parhamsantana_brandextension_mikeroweworks_logo.png" class="img-responsive visible-xs" />
    ...
    <div class="container-fluid block-medium">
        <div class="row no-gutter">
            ...
            <div class="col-sm-4">
                <img class="img-responsive work-top-images" alt="" src="/images/uploads/work/604/parhamsantana_brandextension_mikeroweworks_1__large.jpg">
            </div>
            
            <div class="col-sm-4">
                <img class="img-responsive work-top-images" alt="" src="/images/uploads/work/604/parhamsantana_brandextension_mikeroweworks_2__large.png">
            </div>
            
            <div class="col-sm-4">
                <img class="img-responsive work-top-images" alt="" src="/images/uploads/work/604/parhamsantana_brandextension_mikeroweworks_3__large.jpg">
            </div>
    ...
    <div class="container-fluid shaded-color block-medium" id="blurb">
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                ...
                <p class="block-small">We developed the brand identity for Mike Rowe, TV personality and champion of blue collar trades, to grow his Mike Rowe WORKS Foundation.</p>
